...
import com.example.domain.PizzaDataOnDemand;
...
privileged aspect PizzaDataOnDemand_Roo_DataOnDemand {
    ...
    public Pizza PizzaDataOnDemand.getNewTransientPizza(int index) {
        Pizza obj = new Pizza();
        setDiameter(obj, index);
        setPrice(obj, index);
        return obj;
    }
    
    public void PizzaDataOnDemand.setDiameter(Pizza obj, int index) {
        String diameter = "diameter_" + index;
